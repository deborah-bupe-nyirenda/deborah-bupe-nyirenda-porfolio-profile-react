...
export default function Testimonial() {
  return (
    ...
    <div className="items-start mt-25 md:mt-35 c-space">
      <h2 className="text-heading">Hear What Others are Saying</h2>
      ...
      <div className="from-background pointer-events-none absolute inset-y-0 left-0 w-1/4 bg-gradient-to-r from-primary"></div>
      <div className="from-background pointer-events-none absolute inset-y-0 right-0 w-1/4 bg-gradient-to-l from-primary"></div>
    </div>
    </div>
  )
}
