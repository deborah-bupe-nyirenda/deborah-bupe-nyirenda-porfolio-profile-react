    ...
    <section className="relative flex items-center c-space section-spacing">
      ...
      <div className="flex flex-col items-center justify-center max-w-md p-5 mx-auto border border-white/10  rounded-2xl bg-primary">
        <div className='flex flex-col items-start w-full gap-5 mb-10'>
          <h2 className='text-heading'>Have a Project in Mind?</h2>
          <p className='font-normal text-neutral-400'>I'm here to assist with everything from greenfield website development and platform improvements to complex, one-of-a-kind technical concepts. Reach out and let's explore the possibilities.</p>
        </div>
